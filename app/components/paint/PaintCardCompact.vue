  ...
  >
    ...
    <div class="flex items-center gap-1 flex-shrink-0">
      <button
        ...
        :class="resolvedOwned ? 'text-accent-500' : 'text-gray-300 hover:text-gray-400'"
        aria-label="Toggle owned"
        @click.stop="handleToggleOwned"
      >
        <svg v-if="resolvedOwned" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
      ...
      <button
        class="w-11 h-11 flex items-center justify-center rounded-lg transition-colors"
        :class="resolvedWishlisted ? 'text-pink-300' : 'text-gray-300 hover:text-gray-400'"
        aria-label="Toggle wishlist"
        @click.stop="handleToggleWishlist"
      >
        <svg v-if="resolvedWishlisted" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
